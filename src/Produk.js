...
//   ]
  ...
  const getProduct = () => {
    Axios.get(`https://raw.githubusercontent.com/FarhanFTmei/jsonvivoid/main/ProdukAllseri`)
      .then((res) => {
        const data = res.data;
    ...
    return (
      ...
      <div className="bg-white">
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 className="text-2xl font-extrabold tracking-tight text-gray-900">Semua Model</h2>
            ...
            <a key={products.id}  className="group">
              <div className="group relative">
                ...
                <div className="mt-4 flex justify-between">
                  ...
                  <p className="text-sm font-medium text-gray-900">{products.harga}</p>
                </div>
